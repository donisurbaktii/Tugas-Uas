...
<form action="Update.php" method="POST">
    ...
    <div>
        <label for="mobil">Select Your Car:</label>
        <select id="mobil" name="mobil" required>
            <option value="Avanza" <?= ($data['mobil'] == 'Avanza') ? 'selected' : '' ?>>Avanza</option>
            <option value="Xenia" <?= ($data['mobil'] == 'Xenia') ? 'selected' : '' ?>>Xenia</option>
            <option value="Rush" <?= ($data['mobil'] == 'Rush') ? 'selected' : '' ?>>Rush</option>
        </select>
    </div>
    <div>
